...
public class CLI implements ICLI {
    ...
    public int promptOption(IMenu menu) {
        ...
        if (input <= maxNumber) {
            return input;
        } else throw new RuntimeException("Tato možnost neexistuje, prosíme zadejte validní možnost");
    }
    ...
    public String getWelcomeText() {
        String welcomeText = "\n" +
                "Vítejte v aplikaci ~Task manager~\n" +
                "";
        return welcomeText;
    }
    ...
    private void actionDashboard(IMenu fromMenu) {
        if (logic.isUserLoggedIn()) {
            ...
            drawMessage("Nejste přihlášen, zadejte číslo možnosti :");
        }
    }
