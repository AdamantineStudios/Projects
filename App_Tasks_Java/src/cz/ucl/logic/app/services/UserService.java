...
public class UserService implements IUserService {
    ...
    public void loginUser(String email, String password) throws InvalidCredentialsException, AlreadyLoggedInException {
        if (isUserLoggedIn()) {
            throw new AlreadyLoggedInException("You are already logged in, you have to logout before you will login as somebody else! Už jste přihlášen. Musíte se nejdříve odhlásit aby jste se mohli přihlásit jako někdo jiný.");
        } else {
